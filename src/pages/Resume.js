      ...
      "Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas."
		...
		experience: [
				...
				data: [
          {
						...
						responsibilities: [
              "Communicated with the art director to ensure all projects were completed", "Established trusting relationships with outside venders, designers and key clients.",
              "Worked with a wide range of media, including photography and computer-aided design",
              "Created design theme and graphics for marketing and sales presentations, training videos and corporate websites."
            ],
					},
          {
              ...
              "Managed up to 5 projects or tasks at a given time while under pressure", "Recommended and consulted with clients on the most appropriate graphic design",
				...
				<div className="row">
					<div className="col-lg-6" data-aos="fade-up">
						...
						<h3 className="resume-title">
							{" "}
							<i className="bi bi-person-badge-fill"></i>{summary.title}
						</h3>
						...
						<h3 className="resume-title">
							{" "}
							<i className="bi bi-award-fill"></i>{education.title}
						</h3>
					...
					<div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
						...
						<h3 className="resume-title">
							{" "}
							<i className="bi bi-briefcase-fill"></i>{experience.title}
						</h3>
