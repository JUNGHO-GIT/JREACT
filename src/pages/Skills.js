...
const Skills = () => {
 ...
 useEffect(() => {
  if (activeSection !== -1) {
   const newProgressWidths = skillsSections[activeSection].props.map(
    (prop) => prop.propPercent
   );
   ...
   <div className="container">
    ...
    <div className="row skills-content">
     {skillsSections.map((section, sectionIndex) => (
      <div
       key={sectionIndex}
       className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6"
       data-aos="fade-up"
          ...
          <div className="progress">
           <span className="skill">
            ...
            <i className="val">
             {activeSection === sectionIndex ? (
              <CountUp end={prop.propPercent} duration={1} />
             ) : (
              0
             )}
             %
           ...
           <div className="progress-bar-wrap">
            <div
             ...
             aria-valuemax="100"
             aria-valuenow={
              activeSection === sectionIndex ? prop.propPercent : 0
             }
             style={{
              width: `${
               activeSection === sectionIndex
                ? progressWidths[propIndex] || 0
                : 0
              }%`,
